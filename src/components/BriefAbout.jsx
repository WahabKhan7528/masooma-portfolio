        ...
        <section ref={container} className="relative px-4 sm:px-6 md:px-10 py-24 sm:py-32 overflow-hidden w-full bg-warm/10 dark:bg-dark-bg/20">
            ...
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-start relative z-10">
                ...
                <div className="w-full lg:w-5/12 order-2 lg:order-1">
                    <div className="relative w-full h-auto rounded-[32px] sm:rounded-[40px] overflow-hidden group bg-transparent">
                        ...
                        <img 
                            ...
                            className="w-full h-auto block object-cover object-center transition-transform duration-[2s] ease-out group-hover:scale-95"
                        />
                        {/* Glassmorphism Badge */}
