...
const jobs = [
    {
        ...
        company: 'Freelance',
        type: 'Part-Time',
        desc: 'Working with clients to create intuitive interfaces, design systems, and visual identities that connect with real users.',
    },
    {
        index: '02',
        year: '2026 — Present',
        ...
        company: 'EvonicSoft',
        type: 'Full-Time',
        desc: 'Crafting intuitive interfaces, design systems, and visual identities that connect with real users.',
    },
    {
        index: '03',
        year: '2025 — 2026',
