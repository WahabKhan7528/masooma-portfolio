...
const Hero = memo(() => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 w-full h-full pointer-events-none z-[15] hidden sm:block">
                {/* Large ✿ top left */}
                <div className="floating-flower absolute top-[15%] left-[10%] text-accent-violet opacity-60 text-[80px] font-display flex justify-center items-center">
                    ✿
                </div>
                {/* Medium ✿ top right */}
                <div className="floating-flower absolute top-[25%] right-[18%] text-primary-text opacity-30 text-[50px] font-serif flex justify-center items-center">
                    ✿
                </div>
                {/* Squiggle bottom left */}
                <div className="floating-squiggle absolute bottom-[35%] left-[20%] text-accent-violet opacity-50 w-24">
                    <Squiggle2 className="w-full h-auto" />
                </div>
                {/* Small ✿ bottom right */}
                <div className="floating-flower absolute bottom-[25%] right-[22%] text-accent-violet opacity-80 text-[35px] font-display flex justify-center items-center">
                    ✿
                </div>
                {/* Extra Squiggle top center */}
                <div className="floating-squiggle absolute top-[18%] left-[45%] text-primary-text opacity-20 w-20 rotate-12">
                    <Squiggle1 className="w-full h-auto" />
                </div>
                {/* Additional Squiggle */}
                <div className="floating-squiggle absolute bottom-[20%] left-[40%] text-primary-text opacity-20 w-20 -rotate-12">
                    <Squiggle3 className="w-full h-auto" />
                </div>
                
                {/* --- NEW ELEMENTS --- */}
                {/* Extra small ✿ bottom center */}
                <div className="floating-flower absolute bottom-[15%] right-[45%] text-primary-text opacity-25 text-[25px] font-display flex justify-center items-center">
                    ✿
                </div>
                {/* Squiggle2 mid right */}
                <div className="floating-squiggle absolute top-[45%] right-[8%] text-accent-violet opacity-40 w-16 rotate-45">
                    <Squiggle2 className="w-full h-auto" />
                </div>
                {/* Massive ✿ mid left */}
                <div className="floating-flower absolute top-[55%] left-[4%] text-primary-text opacity-10 text-[120px] font-serif flex justify-center items-center">
                    ✿
                </div>
                {/* Squiggle1 bottom right edge */}
                <div className="floating-squiggle absolute bottom-[12%] right-[5%] text-primary-text opacity-15 w-28 -rotate-45">
                    <Squiggle1 className="w-full h-auto" />
                </div>
                {/* Tiny ✿ top center-right */}
                <div className="floating-flower absolute top-[12%] right-[35%] text-accent-violet opacity-70 text-[20px] font-display flex justify-center items-center">
                    ✿
                </div>
            </div>
